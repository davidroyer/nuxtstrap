<template>
  <div class>
    ...
    <b-button variant="primary" @click="modalShow = !modalShow">Open Modal</b-button>
    <b-modal v-model="modalShow" title="Nuxt Quickstart">
      <p class="my-4">Some modal content here...</p>
    </b-modal>
    <hr />
    <b-form-input id="title" type="text" v-model="post.title" placeholder="Post Title"></b-form-input>
    <b-form-textarea
      id="body"
      v-model="post.body"
